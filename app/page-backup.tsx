...
export default function Home() {
  ...
  const getCartQuantity = (productName: string, size: Size) => {
    return cart
      .filter(
        (item) =>
  ...
  const addToCart = (product: Product) => {
    const size = selectedSizes[product.name] || "M";

    const remaining = getRemainingStock(product, size);
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <nav className="flex items-center justify-between px-6 py-6 md:px-12">
        ...
        <button
          ...
          className="border border-white px-5 py-2 text-xs uppercase tracking-widest transition-all hover:bg-white hover:text-black"
        >
          Cart ({totalItems})
        </button>
      </nav>
      ...
      <section className="relative flex min-h-[85vh] flex-col items-center justify-center overflow-hidden px-6 text-center">
        ...
        <div className="relative z-10">
          ...
          <p className="mb-6 text-[10px] font-medium uppercase tracking-[0.5em] text-zinc-500 sm:text-xs">
            LF Wear — Drop 01
          </p>
          ...
          <p className="mx-auto mt-8 max-w-md text-sm leading-7 text-zinc-400">
            Bold designs. Premium quality. Limited pieces.
            <br />
            Made to stand out.
          </p>
          ...
          <a
            href="#shop"
            className="mt-10 inline-block border border-white bg-white px-10 py-4 text-[10px] font-bold uppercase tracking-[0.3em] text-black transition-all duration-300 hover:bg-transparent hover:text-white"
          >
            Discover Drop 01
          </a>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {products.map((product) => {
            ...
            return (
              <div
                key={product.name}
                className="group overflow-hidden border border-zinc-800 bg-zinc-950 transition-all duration-300 hover:border-zinc-500"
              >
                ...
                <div className="relative aspect-[4/5] overflow-hidden bg-zinc-900">
                  ...
                  <div className="absolute left-4 top-4 border border-white/20 bg-black/70 px-3 py-2 text-[9px] uppercase tracking-[0.2em] backdrop-blur-sm">
                    Drop 01
                  </div>
                ...
                <div className="p-5">
                      ...
                      {sizes.map((size) => {
                        ...
                        return (
                          <button
                            ...
                            className={`relative border py-3 text-xs font-semibold transition-all ${
                              selectedSize === size &&
                              sizeRemaining > 0
                          ...
                          >
                            ...
                            {sizeRemaining <= 0 && (
                              <span className="absolute inset-0 flex items-center justify-center text-[7px] uppercase tracking-wider">
                                Sold
                              </span>
                            )}
                  ...
                  <button
                    ...
                    className={`mt-4 block w-full border px-4 py-3 text-center text-[10px] font-bold uppercase tracking-[0.2em] transition-all duration-300 ${
                      remaining > 0
                  ...
                  <a
                    ...
                    className={`mt-2 block w-full border px-4 py-3 text-center text-[10px] font-bold uppercase tracking-[0.2em] transition-all ${
                      remaining > 0
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-12 max-w-2xl">
            ...
            <p className="mt-5 text-sm leading-8 text-zinc-400">
              We create bold, unique designs using premium-quality materials, produced in limited quantities. Every drop is designed to be different — because your style should be your identity.
            </p>
        ...
        <div className="flex flex-col justify-between gap-8 md:flex-row md:items-end">
          ...
          <div className="text-left md:text-right">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-3 block text-xs uppercase tracking-[0.2em] transition-opacity hover:opacity-50"
            >
                ...
                <div className="flex h-full items-center justify-center text-center">
                  ...
                  <div>
                    ...
                    <button
                      ...
                      className="mt-6 border border-white px-6 py-3 text-[10px] font-bold uppercase tracking-widest hover:bg-white hover:text-black"
                    >
                      Discover Drop 01
                    </button>
                              ...
                              <div className="mt-4 flex items-center justify-between">
                                ...
                                <div className="flex items-center border border-zinc-700">
                                  ...
                                  <button
                                    ...
                                    className="px-3 py-2 text-sm hover:bg-white hover:text-black"
                                  >
                                    −
                                  </button>
                                  ...
                                  <button
                                    ...
                                    className="px-3 py-2 text-sm hover:bg-white hover:text-black disabled:cursor-not-allowed disabled:opacity-30"
                                  >
                                    +
                                  </button>
            ...
            {cart.length > 0 && (
              ...
              <div className="border-t border-zinc-800 p-6">
                ...
                <button
                  ...
                  className="block w-full bg-white px-6 py-4 text-center text-[10px] font-bold uppercase tracking-[0.2em] text-black transition-all hover:bg-zinc-200"
                >
                  Checkout
                </button>
        ...
        <div className="fixed inset-0 z-[60] overflow-y-auto bg-black">
          ...
          <div className="mx-auto min-h-screen max-w-2xl px-6 py-10 md:px-10">
            ...
            <div className="mt-10">
              ...
              <div className="mt-6 space-y-4">
                ...
                <input
                  ...
                  className="w-full border border-zinc-800 bg-zinc-950 px-4 py-4 text-sm outline-none placeholder:text-zinc-600 focus:border-white"
                />
                ...
                <select
                  ...
                  className="w-full border border-zinc-800 bg-zinc-950 px-4 py-4 text-sm text-white outline-none focus:border-white"
                >
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full resize-none border border-zinc-800 bg-zinc-950 px-4 py-4 text-sm outline-none placeholder:text-zinc-600 focus:border-white"
                />
            ...
            <button
              ...
              className="mt-8 w-full bg-white px-6 py-5 text-[10px] font-bold uppercase tracking-[0.25em] text-black transition-all hover:bg-zinc-200"
            >
            ...
            <button
              ...
              className="mt-3 w-full border border-zinc-800 px-6 py-4 text-[10px] font-bold uppercase tracking-[0.25em] text-zinc-400 transition-all hover:border-white hover:text-white"
            >
              Back to Cart
            </button>
